  ...
  return (
    <LinearGradient colors={[Colors.background, "#0E1324"]} style={styles.container}>
      ...
      <View style={[styles.card, Shadows.soft]}>
        ...
        <TouchableOpacity onPress={signup} disabled={loading} style={styles.primaryButton}>
          <LinearGradient colors={[Colors.neonPurple, Colors.neonMagenta]} style={styles.buttonGradient}>
